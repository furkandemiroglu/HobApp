...
List<MusicModel> tiredMusicList = [
  const MusicModel(
    id: 1,
    title: 'Happy',
...
List<MovieModel> tiredMovieList = [
  const MovieModel(
    id: 1,
    title: 'La La Land',
    desc:
    ...
    photo: 'assets/happy.jpeg',
    reviews: ['Harika bir film', 'Kesinlikle izleyin'],
  ),
  const MovieModel(
    id: 2,
    title: 'Happy',
    ...
    photo: 'assets/happy.jpeg',
    reviews: ['Mükemmel', 'harika'],
  ),
];

List<BookModel> tiredBookList = [
  const BookModel(
    id: 1,
...
T getTiredRandomItem<T>(List<T> list) {
  final random = Random();
