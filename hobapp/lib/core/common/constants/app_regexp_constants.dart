class AppRegExpConstans {
  static AppRegExpConstans? _instance;
  static AppRegExpConstans? get instance {
    _instance ??= AppRegExpConstans._init();
    return _instance;
  }

  AppRegExpConstans._init();
